...
namespace Toolkit.DataStructures
{
    ...
    public class OrderedList<TItem, UWheight> : DoublyLinkedList<Pair<TItem, UWheight>> where UWheight : IComparable<UWheight>
    {
        public static OrderedList<TItem, UWheight> operator +(OrderedList<TItem, UWheight> self, IListExtented<Pair<TItem, UWheight>> other)
        {
    ...
    public class OrderedList<T> : DoublyLinkedList<T> where T : IComparable<T>
    {
        public static OrderedList<T> operator +(OrderedList<T> self, IListExtented<T> other)
        {
