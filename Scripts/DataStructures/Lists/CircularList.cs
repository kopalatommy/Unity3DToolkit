...
{
    public class CircularList<T> : ICollection, IEnumerable
    {
        ...
        CircularListEnumerator<T> enumerator = null;
        ...
        {
            buffer = new T[0];
            enumerator = new CircularListEnumerator<T>(this);
        }
    ...
    public class CircularListEnumerator<T> : IEnumerator
    {
