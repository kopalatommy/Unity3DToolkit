...
{
    public class RedBlackTreeTester : TesterBase
    {
        public RedBlackTreeTester()
        {
            testName = "Red Black Tree";
            testType = typeof(RedBlackTreeTester);
        }

        [RunTest(false)]
        public bool InsertTest1()
        {
            RedBlackTreeV2<int> tree = new RedBlackTreeV2<int>();
            ...
            for (int i = 0; i < 100; i++)
                if (!tree.Contains(i))
                {
                    Debug.Log("Red Black Tree does not contain: " + i);
                    Debug.Log(tree);
                    return false;
                }
        ...
        public bool RemoveTest1()
        {
            ...
            if(verbose)
                Debug.Log("Starting remove test 1");
            ...
            if (tree.Count != 0)
            {
                Debug.Log("RedBlackTreeV2 RemoveTest 1 failed. Count != 0: " + tree.Count);
                return false;
            }
            else
                return true;
