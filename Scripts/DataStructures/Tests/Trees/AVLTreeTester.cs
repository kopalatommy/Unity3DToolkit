...
{
    public class AVLTreeTester : TesterBase
    {
        public AVLTreeTester()
        {
            testName = "AVL Tree";
            testType = typeof(AVLTreeTester);
        }

        [RunTest(false)]
        public bool InsertTest1()
        {
            AVLTreeV2<int> tree = new AVLTreeV2<int>();
        ...
        public bool RemoveTest1()
        {
            ...
            if (tree.Count != 0)
            {
                Debug.Log("AVLTree RemoveTest 1 failed. Count != 0: " + tree.Count);
                return false;
            }
            else
                return true;
