...
{
    public class BTreeTester : TesterBase
    {
        public BTreeTester()
        {
            testName = "B Tree";
            testType = typeof(BTreeTester);
        }
        ...
        public bool RemoveTest1()
        {
            ...
            if (tree.Count != 0)
            {
                Debug.Log("BTree RemoveTest 1 failed. Count != 0: " + tree.Count);
                return false;
            }
            else
                return true;
        ...
        public bool GenTest2()
        {
            ...
            {
                BTree<int> tree = new BTree<int>(rand.Next(3, 10));
                for (int i = 0; i < 100; i++)
                    source.AppendBack(i);
                for (int i = 99; i >= 0; i--)
                    tree.Insert(source.TakeAt(rand.Next(0, i)));
